...
func getActiveChats(c *gin.Context) {
	...
	// Log the output to debug the response
	fmt.Println("Active Chats JSON Response:", activeChats)

	// Send JSON response
	c.JSON(http.StatusOK, gin.H{"activeChats": activeChats}) // Fixed JSON format
}
